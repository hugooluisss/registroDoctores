...
CREATE TABLE `tipoServicio` (
  ...
  `idClasificacion` tinyint(3) unsigned NOT NULL,
  PRIMARY KEY (`idTipo`),
  KEY `clasificacion` (`idClasificacion`),
  CONSTRAINT `idClasi-clasificacion` FOREIGN KEY (`idClasificacion`) REFERENCES `clasificacion` (`idClasificacion`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tipoServicio` VALUES (1,'Consultas',1),(4,'TA',2),(5,'Procedimientos médicos',2),(6,'Medicina preventiva',2);
